...
public:
	...
	struct ADC_Destination_t {
		...
		static constexpr size_t BLOCK_VALID_SHIFT = 31;
		...
		ADC_Destination_t(uint32_t block_index, uint32_t sub_index, uint32_t throwaway):
			dest_data( 	((block_index & BLOCK_INDEX_MASK) << BLOCK_INDEX_SHIFT) |
						...
						( BLOCK_VALID_MASK << BLOCK_VALID_SHIFT)					)
		{}
		...
		__attribute__((always_inline)) inline bool valid()				{ return ( dest_data & (BLOCK_VALID_MASK << BLOCK_VALID_SHIFT));	}
	};
