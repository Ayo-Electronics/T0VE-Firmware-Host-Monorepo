...
from host_application.state_proto_defs import NodeState, WgBiasSetpoints, Uint324, Bool4, Uint322, Uint3210
...
class NodeStateDefaults:
    ...
    def default_command_empty() -> NodeState:
        #just return a default node state with a correct magic number
